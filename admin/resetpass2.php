...
<html lang="en">
    <head>
        ...
        <title>Bootstrap Forgot Password Form Templates</title>
        <!-- CSS -->
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>Form Reset Password</strong></h1>                            
                        </div>
                    </div>
                        	...
                        	<div class="form-box">
	                        	<div class="form-top">
	                        		<div class="form-top-left">
	                            		...
	                            		<p>Input Email, Password Baru, dan Password Lama</p>
	                        		</div>
	                            ...
	                            <div class="form-bottom">
				                    <form role="form" action="" method="post" class="login-form">
				                    	<div class="form-group">
                                            ...
                                            <button type="submit" name="submit" class="btn col-sm-5">Submit</button>
                                            <br><br>
				                    </form>
                                </div>
                            </div>
