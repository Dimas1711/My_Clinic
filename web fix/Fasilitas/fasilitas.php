                  ...
                  <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                      ...
                      <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="Profil/profil.html">Data Klinik</a>
                            <a class="dropdown-item" href="#">Struktur Organisasi</a>
                            <a class="dropdown-item" href="#">Civitas</a>
                      </div>
                    </li>
                    <li class="nav-item ">
                      <a class="nav-link" href="Fasilitas/fasilitas.html">
                        Fasilitas
                        <span class="sr-only" >
                            (current)
                        </span>
                    ...
                    <li class="nav-item ">
                            <a class="nav-link" href="lain - lain/lain-lain.html">
                              Lain Lain
                            </a>
                      ...
                      <div class="carousel-inner">
                        ...
                        <div class="carousel-item active">
                          ...
                          <div class="carousel-caption d-none d-md-block">
                            <h5>Kelompok 3</h5>
                            <p>Ketuanya tukang afk , KETUA MAH BEBASSSS</p>
                          </div>
